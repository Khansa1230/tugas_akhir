        ...
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0" style="font-size: 1.2rem;">
                    <a href="{{ route('penanggung_jawab_klasifikasi_c45_mahasiswa_jurusan_agribisnis') }}" 
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('penanggung_jawab_prediksi_mahasiswa_jurusan_agribisnis') }}">
                    @csrf
