        ...
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0" style="font-size: 1.2rem;">
                    <a href="{{ route('penanggung_jawab_klasifikasi_c45_mahasiswa_jurusan_biologi') }}" 
                    style="text-decoration: none; color: inherit;">
                    Klasifikasi Algoritma C45 Jurusan Biologi
                    </a>
                    <span class="text-muted">- Prediksi Jurusan Biologi</span>
                </h4>
            </div>

            <div class="card-body">
                <form method="POST" action="{{ route('penanggung_jawab_prediksi_mahasiswa_jurusan_biologi') }}">
                    @csrf
