    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    <span class="text-muted">Klasifikasi Algoritma C45 Jurusan Biologi</span> - 
                    <a href="{{ route('penanggung_jawab_prediksi_mahasiswa_jurusan_biologi') }}" 
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('penanggung_jawab_klasifikasi_c45_mahasiswa_jurusan_biologi') }}">
                    @csrf
