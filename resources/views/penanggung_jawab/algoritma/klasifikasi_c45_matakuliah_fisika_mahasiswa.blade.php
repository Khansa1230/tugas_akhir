    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    <span class="text-muted">Klasifikasi Algoritma C45 Jurusan Fisika</span> - 
                    <a href="{{ route('penanggung_jawab_prediksi_mahasiswa_jurusan_fisika') }}" 
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('penanggung_jawab_klasifikasi_c45_mahasiswa_jurusan_fisika') }}">
                    @csrf
