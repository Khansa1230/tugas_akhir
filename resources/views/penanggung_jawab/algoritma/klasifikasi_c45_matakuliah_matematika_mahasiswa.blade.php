        ...
        <div class="card">
            <div class="card-header">
                <h4>
                    ...
                    <a href="{{ route('penanggung_jawab_prediksi_mahasiswa_jurusan_matematika') }}" 
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('penanggung_jawab_klasifikasi_c45_mahasiswa_jurusan_matematika') }}">
                    @csrf
