    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4>
                    <span class="text-muted">Klasifikasi Algoritma C45 Jurusan Agribisnis</span> - 
                    <a href="{{ route('dosen_prediksi_mahasiswa_agribisnis') }}" 
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('dosen_klasifikasi_c45_mahasiswa_agribisnis') }}">
                    @csrf
