        ...
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0" style="font-size: 1.2rem;">
                    <a href="{{ route('dosen_klasifikasi_c45_mahasiswa_matematika') }}" 
                    style="text-decoration: none; color: inherit;">
                    Klasifikasi Algoritma C45 Jurusan Matematika
                    </a>
                    <span class="text-muted">- Prediksi Jurusan Matematika</span>
                </h4>
            </div>

            <div class="card-body">
                <form method="POST" action="{{ route('dosen_prediksi_mahasiswa_matematika') }}">
                    @csrf
