@extends('dosen.teknik_informatika.kerangka.master')
...
<div class="page-heading">
    ...
    <h4 class="mb-0" style="font-size: 1.2rem;">
        <a href="{{ route('dosen_klasifikasi_c45_mahasiswa_teknik_informatika') }}" 
           style="text-decoration: none; color: inherit;">
           Klasifikasi Algoritma C45 Jurusan Teknik Informatika
        </a>
        <span class="text-muted">- Prediksi Jurusan Teknik Informatika</span>
    </h4>
</div>

<div class="card-body">
    <form method="POST" action="{{ route('dosen_prediksi_mahasiswa_teknik_informatika') }}">
        @csrf
