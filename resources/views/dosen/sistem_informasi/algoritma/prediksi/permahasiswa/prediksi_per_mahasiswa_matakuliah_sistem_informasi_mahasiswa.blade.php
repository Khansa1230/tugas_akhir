@extends('dosen.sistem_informasi.kerangka.master')
...
<div class="page-heading">
    <section class="section">
        <div class="card">
            ...
            <form method="GET" action="{{ route('dosen_prediksi_per_mahasiswa_matakuliah_sistem_informasi_mahasiswa') }}" id="filter-form">
                @csrf
                <div class="card-body">
