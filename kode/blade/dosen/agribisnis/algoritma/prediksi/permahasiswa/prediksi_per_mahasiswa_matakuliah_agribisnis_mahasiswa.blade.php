@extends('dosen.agribisnis.kerangka.master')
...
<div class="page-heading">
    <section class="section">
        <div class="card">
            ...
            <form method="GET" action="{{ route('dosen_prediksi_per_mahasiswa_matakuliah_agribisnis_mahasiswa') }}" id="filter-form">
                @csrf
                <div class="card-body">
