...
class DosenKlasifikasiC45Controller extends Controller
{
    ...
    public function dosen_klasifikasi_mahasiswa_biologi(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.klasifikasi_c45_matakuliah_biologi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_prediksi_mahasiswa_biologi(Request $request)
    {
      ...
      $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.prediksi.prediksi_matakuliah_biologi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_klasifikasi_mahasiswa_fisika(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.klasifikasi_c45_matakuliah_fisika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_prediksi_mahasiswa_fisika(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.prediksi.prediksi_matakuliah_fisika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_klasifikasi_mahasiswa_kimia(Request $request)
    {
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.klasifikasi_c45_matakuliah_kimia_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_prediksi_mahasiswa_kimia(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.prediksi.prediksi_matakuliah_kimia_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_klasifikasi_mahasiswa_matematika(Request $request)
    {
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.klasifikasi_c45_matakuliah_matematika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_prediksi_mahasiswa_matematika(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.prediksi.prediksi_matakuliah_matematika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_klasifikasi_mahasiswa_sistem_informasi(Request $request)
    {
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.klasifikasi_c45_matakuliah_sistem_informasi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_prediksi_mahasiswa_sistem_informasi(Request $request)
    {
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.prediksi.prediksi_matakuliah_sistem_informasi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_klasifikasi_mahasiswa_teknik_informatika(Request $request)
    {
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.klasifikasi_c45_matakuliah_teknik_informatika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_prediksi_mahasiswa_teknik_informatika(Request $request)
    {
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.algoritma.prediksi.prediksi_matakuliah_teknik_informatika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function dosen_klasifikasi_mahasiswa_teknik_tambang(Request $request)
    {
       ...
       // Konversi hasil query ke array
        ...
        return view('dosen.algoritma.klasifikasi_c45_matakuliah_teknik_tambang_mahasiswa', compact('outputData', 'predictedLulus' 
            ));
    }
    ...
    public function dosen_prediksi_mahasiswa_teknik_tambang(Request $request)
    {
       ...
       // Konversi hasil query ke array
        ...
        // Mengembalikan view dengan data dan pemetaan kolom
        return view('dosen.algoritma.prediksi.prediksi_matakuliah_teknik_tambang_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'
            ));
    }
