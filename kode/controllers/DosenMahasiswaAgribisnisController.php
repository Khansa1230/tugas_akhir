...
class DosenMahasiswaAgribisnisController extends Controller
{
    public function dosen_jumlah_mahasiswa_kelamin_agribisnis(Request $request) {
        ...
        return view('agribisnis.mahasiswa.jenis_kelamin_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
    ...
    public function dosen_jumlah_mahasiswa_status_agribisnis(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('agribisnis.mahasiswa.jenis_status_mahasiswa', compact('years',  'allStatus',  'query'));
    }
    ...
    public function dosen_jumlah_mahasiswa_jenis_seleksi_agribisnis(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('agribisnis.mahasiswa.jenis_seleksi_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
    ...
    public function dosen_jumlah_mahasiswa_propinsi_agribisnis(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('agribisnis.mahasiswa.jenis_propinsi_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
    ...
    public function dosen_jumlah_mahasiswa_kota_agribisnis(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('agribisnis.mahasiswa.jenis_kota_mahasiswa', compact('years',  'allStatus', 'allPropinsi',  'selectedStatus'));
    }
    ...
    public function dosen_jumlah_mahasiswa_jenis_sekolah_agribisnis(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('agribisnis.mahasiswa.jenis_sekolah_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
    ...
    public function dosen_jumlah_mahasiswa_satuan_kredit_semester_agribisnis(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('agribisnis.mahasiswa.jenis_satuan_kredit_semester_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
    ...
    public function dosen_jumlah_mahasiswa_indeks_prestasi_kumulatif_agribisnis(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('agribisnis.mahasiswa.jenis_indeks_prestasi_kumulatif_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
