...
# Path File
# ==============================================
json_file_path = r'C:\xampp\htdocs\skripsi\app\python_scripts\fisika\data.json'
test_size_file_path = r'C:\xampp\htdocs\skripsi\app\python_scripts\fisika\test_size.json'

output_image_path = r'C:\xampp\htdocs\skripsi\public\images\fisika\tree.png'
output_image_relative = 'images/fisika/tree.png'  # untuk asset() Laravel
...
if not os.path.exists(json_file_path):
    ...
    try:
        ...
        atribut = [
            ...
            'kategori_pkl', 'kategori_kkn', 'kategori_seminar', 'judisium'
        ]
