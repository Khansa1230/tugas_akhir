...
# Path File
# ==============================================
json_file_path = r'C:\xampp\htdocs\skripsi\app\python_scripts\teknik_tambang\data.json'
test_size_file_path = r'C:\xampp\htdocs\skripsi\app\python_scripts\teknik_tambang\test_size.json'

output_image_path = r'C:\xampp\htdocs\skripsi\public\images\teknik_tambang\tree.png'
output_image_relative = 'images/teknik_tambang/tree.png'  # untuk asset() Laravel
...
if not os.path.exists(json_file_path):
    ...
    try:
        ...
        output['test_df'] = test_df.to_dict(orient='records')  # tambahkan test_df
        ...
        # ===== Fungsi proses perhitungan entropy/gain =====
        ...
        # ===== Target & atribut =====
        target = 'kategori'
        atribut = ['kategori_sks', 'kategori_ipk', 'ipsmt_1', 'ipsmt_2', 'ipsmt_3', 'ipsmt_4', 'ipsmt_5', 'ipsmt_6', 'ipsmt_7', 'kategori_geologi_lapangan', 'kategori_kuliah_lapangan_1', 'kategori_kuliah_lapangan_2', 'kategori_kuliah_kerja_nyata', 'kategori_pkl', 'kategori_seminar', 'judisium']

        # ===== Jalankan proses hitungan manual (kategori asli) =====
