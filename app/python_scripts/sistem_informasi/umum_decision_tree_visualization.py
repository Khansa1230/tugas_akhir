...
if not os.path.exists(json_file_path):
    ...
    try:
        ...
        def entropy(total, belum_lulus, lulus):
            ...
            return ent  # ❌ hapus round

        # ===== Fungsi hitung gain (FIX) =====
        def gain(df, col, target):
            ...
            gain_val = total_entropy - weighted_entropy  # ❌ hapus round
        ...
        # ===== Target & atribut =====
        target = 'kategori'
        atribut = ['jenis_sekolah', 'kategori_sks', 'kategori_ipk', 'ipsmt_1', 'ipsmt_2', 'ipsmt_3', 'ipsmt_4', 
                   'ipsmt_5', 'ipsmt_6', 'ipsmt_7', 'kategori_pkl', 'kategori_kkn', 'kategori_seminar', 'judisium']
