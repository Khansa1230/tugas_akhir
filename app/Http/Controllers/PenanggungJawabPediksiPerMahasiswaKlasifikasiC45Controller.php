...
class PenanggungJawabPediksiPerMahasiswaKlasifikasiC45Controller extends Controller
{
   public function penanggung_jawab_prediksi_per_mahasiswa_jurusan_agribisnis(Request $request)
    {
       ...
       $outputData = [
        ...
        // ======================================================
        $statusPrediksi = null;
        $prediksiFilePath = 'C:\\xampp\\htdocs\\skripsi\\app\\python_scripts\\agribisnis\\prediksi_status.json';
        ...
        // Return ke view
        return view(
            'penanggung_jawab.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_agribisnis_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }
 
    public function penanggung_jawab_prediksi_per_mahasiswa_jurusan_biologi(Request $request)
    {
        ...
        $query12 = DB::table('matakuliah as mk')
            ...
            ->select(
                ...
                DB::raw("CASE 
                    WHEN mk.kuliah_kerja_lapangan IS NOT NULL AND mk.kuliah_kerja_lapangan != '' 
                        THEN CONCAT('Semester ', mk.kuliah_kerja_lapangan)
                    WHEN mk.kuliah_kerja_lapangan IS NULL OR mk.kuliah_kerja_lapangan = '' 
                        THEN NULL
                END AS kategori_pkl"),
                DB::raw("CASE 
                    WHEN mk.seminar_proposal IS NOT NULL AND mk.seminar_proposal != '' 
                        THEN CONCAT('Semester ', mk.seminar_proposal)
                    WHEN mk.seminar_proposal IS NULL OR mk.seminar_proposal = '' 
                        THEN NULL
                END AS kategori_seminar_proposal"),
                DB::raw("CASE 
                    WHEN mk.seminar IS NOT NULL AND mk.seminar != '' 
       ...
       $outputData = [
        ...
        // ======================================================
        $statusPrediksi = null;
        $prediksiFilePath = 'C:\\xampp\\htdocs\\skripsi\\app\\python_scripts\\biologi\\prediksi_status.json';
        ...
        // Return ke view
        return view(
            'penanggung_jawab.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_biologi_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }
     
    public function penanggung_jawab_prediksi_per_mahasiswa_jurusan_fisika(Request $request)
    {
        ...
        $query12 = DB::table('matakuliah as mk')
            ...
            ->select(
                ...
                DB::raw("CASE 
                    ...
                    WHEN mk.seminar IS NOT NULL AND TRIM(REPLACE(REPLACE(mk.seminar, '\r', ''), '\n', '')) != '' 
                        THEN CONCAT('Semester ', TRIM(REPLACE(REPLACE(mk.seminar, '\r', ''), '\n', '')))
                    WHEN mk.seminar_skripsi IS NULL AND mk.seminar IS NULL 
                        THEN NULL
                END AS seminar"),
                'js.jenis_sekolah AS jenis_sekolah'
            )
       ...
       $outputData = [
        ...
        // ======================================================
        $statusPrediksi = null;
        $prediksiFilePath = 'C:\\xampp\\htdocs\\skripsi\\app\\python_scripts\\fisika\\prediksi_status.json';
        ...
        // Return ke view
        return view(
            'penanggung_jawab.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_fisika_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }

     public function penanggung_jawab_prediksi_per_mahasiswa_jurusan_kimia(Request $request)
    {
       ...
       $outputData = [
        ...
        // ======================================================
        $statusPrediksi = null;
        $prediksiFilePath = 'C:\\xampp\\htdocs\\skripsi\\app\\python_scripts\\kimia\\prediksi_status.json';
        ...
        // Return ke view
        return view(
            'penanggung_jawab.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_kimia_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }

    public function penanggung_jawab_prediksi_per_mahasiswa_jurusan_matematika(Request $request)
    {
       ...
       $outputData = [
        ...
        // ======================================================
        $statusPrediksi = null;
        $prediksiFilePath = 'C:\\xampp\\htdocs\\skripsi\\app\\python_scripts\\matematika\\prediksi_status.json';
        ...
        // Return ke view
        return view(
            'penanggung_jawab.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_matematika_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }

    public function penanggung_jawab_prediksi_per_mahasiswa_jurusan_sistem_informasi(Request $request)
    {
       ...
       $outputData = [
        ...
        // ======================================================
        $statusPrediksi = null;
        $prediksiFilePath = 'C:\\xampp\\htdocs\\skripsi\\app\\python_scripts\\sistem_informasi\\prediksi_status.json';
        ...
        // Return ke view
        return view(
            'penanggung_jawab.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_sistem_informasi_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }

    public function penanggung_jawab_prediksi_per_mahasiswa_jurusan_teknik_informatika(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'penanggung_jawab.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_teknik_informatika_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }
     public function penanggung_jawab_prediksi_per_mahasiswa_jurusan_teknik_tambang(Request $request)
    {
        ...
        ->select(
            ...
            'mk.sks AS kategori_sks',
            'mk.ipk AS kategori_ipk',
            DB::raw("CASE 
                    WHEN mk.ipsmt_1 IS NOT NULL AND mk.ipsmt_1 != '' 
                        THEN mk.ipsmt_1
                    ELSE NULL
            ...
            DB::raw("CASE 
                WHEN mk.geologi_lapangan IS NOT NULL AND mk.geologi_lapangan != '' 
                    THEN CONCAT('Semester ', mk.geologi_lapangan)
                WHEN mk.geologi_lapangan IS NULL OR mk.geologi_lapangan = '' 
                    THEN NULL
            END AS kategori_geologi_lapangan"),

            DB::raw("CASE 
                WHEN mk.kuliah_lapangan_1 IS NOT NULL AND mk.kuliah_lapangan_1 != '' 
                    THEN CONCAT('Semester ', mk.kuliah_lapangan_1)
                WHEN mk.kuliah_lapangan_1 IS NULL OR mk.kuliah_lapangan_1 = '' 
                    THEN NULL
            END AS kategori_kuliah_lapangan_1"),

            DB::raw("CASE 
                WHEN mk.kuliah_lapangan_2 IS NOT NULL AND mk.kuliah_lapangan_2 != '' 
                    THEN CONCAT('Semester ', mk.kuliah_lapangan_2)
                WHEN mk.kuliah_lapangan_2 IS NULL OR mk.kuliah_lapangan_2 = '' 
                    THEN NULL
            END AS kategori_kuliah_lapangan_2"),
            ...
            DB::raw("CASE 
                ...
                WHEN mk.kuliah_lapangan IS NOT NULL AND mk.kuliah_lapangan != ''
                    THEN CONCAT('Semester ', mk.kuliah_lapangan)
                WHEN mk.kuliah_kerja_lapangan IS NULL AND mk.kuliah_lapangan IS NULL 
                    THEN NULL
            END AS kategori_pkl"),
       ...
       $outputData = [
        ...
        // ======================================================
        $statusPrediksi = null;
        $prediksiFilePath = 'C:\\xampp\\htdocs\\skripsi\\app\\python_scripts\\teknik_tambang\\prediksi_status.json';
        ...
        // Return ke view
        return view(
            'penanggung_jawab.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_teknik_tambang_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }
