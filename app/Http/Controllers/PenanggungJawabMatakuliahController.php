...
class PenanggungJawabMatakuliahController extends Controller
{
    public function index(){
        return view ('penanggung_jawab.mahasiswa.matakuliah');
    }

    public function penanggung_jawab_jumlah_mahasiswa_matakuliah_jurusan_teknik_informatika(Request $request)
    {
        ...
        return view('penanggung_jawab.mahasiswa.jenis_matakuliah_teknik_informatika_mahasiswa', compact(
            'years', 
            'allStatus', 
            'year', 
            'selectedStatus', 
    ...
    public function penanggung_jawab_jumlah_mahasiswa_matakuliah_jurusan_agribisnis(Request $request)
    {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_matakuliah_agribisnis_mahasiswa', compact(
            'years', 
            'allStatus', 
            'year', 
            'selectedStatus', 
    ...
    public function penanggung_jawab_jumlah_mahasiswa_matakuliah_jurusan_biologi(Request $request)
    {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_matakuliah_biologi_mahasiswa', compact(
            'years', 
            'allStatus', 
            'year', 
            'selectedStatus', 
    ...
    public function penanggung_jawab_jumlah_mahasiswa_matakuliah_jurusan_fisika(Request $request)
    {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_matakuliah_fisika_mahasiswa', compact(
            'years', 
            'allStatus', 
            'year', 
            'selectedStatus', 
    ...
    public function penanggung_jawab_jumlah_mahasiswa_matakuliah_jurusan_kimia(Request $request)
    {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_matakuliah_kimia_mahasiswa', compact(
            'years', 
            'allStatus', 
            'year', 
            'selectedStatus', 
    ...
    public function penanggung_jawab_jumlah_mahasiswa_matakuliah_jurusan_matematika(Request $request)
    {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_matakuliah_matematika_mahasiswa', compact(
            'years', 
            'allStatus', 
            'year', 
            'selectedStatus', 
    ...
    public function penanggung_jawab_jumlah_mahasiswa_matakuliah_jurusan_sistem_informasi(Request $request)
    {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_matakuliah_sistem_informasi_mahasiswa', compact(
            'years', 
            'allStatus', 
            'year', 
            'selectedStatus', 
    ...
    public function penanggung_jawab_jumlah_mahasiswa_matakuliah_jurusan_teknik_tambang(Request $request)
    {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_matakuliah_teknik_tambang_mahasiswa', compact(
            'years', 
            'allStatus', 
            'year', 
            'selectedStatus', 
