...
class UtamaPediksiPerMahasiswaKlasifikasiC45AgribisnisController extends Controller
{

    public function prediksi_per_mahasiswa_jurusan_agribisnis(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'utama.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_agribisnis_mahasiswa',
