...
class DosenMahasiswaSistemInformasiController extends Controller
{
    public function dosen_jumlah_mahasiswa_kelamin_sistem_informasi(Request $request) {
        ...
        return view('dosen.sistem_informasi.mahasiswa.jenis_kelamin_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
    
    public function dosen_jumlah_mahasiswa_status_sistem_informasi(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('dosen.sistem_informasi.mahasiswa.jenis_status_mahasiswa', compact('years',  'allStatus',  'query'));
    }

    public function dosen_jumlah_mahasiswa_jurusan_sistem_informasi(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
    ...
    public function dosen_jumlah_mahasiswa_jenis_seleksi_sistem_informasi(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('dosen.sistem_informasi.mahasiswa.jenis_seleksi_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
    
    public function dosen_jumlah_mahasiswa_propinsi_sistem_informasi(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('dosen.sistem_informasi.mahasiswa.jenis_propinsi_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }

    public function dosen_jumlah_mahasiswa_kota_sistem_informasi(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('dosen.sistem_informasi.mahasiswa.jenis_kota_mahasiswa', compact('years',  'allStatus', 'allPropinsi',  'selectedStatus'));
    }
    
    
    public function dosen_jumlah_mahasiswa_jenis_sekolah_sistem_informasi(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('dosen.sistem_informasi.mahasiswa.jenis_sekolah_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }

    public function dosen_jumlah_mahasiswa_satuan_kredit_semester_sistem_informasi(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('dosen.sistem_informasi.mahasiswa.jenis_satuan_kredit_semester_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
    

    public function dosen_jumlah_mahasiswa_indeks_prestasi_kumulatif_sistem_informasi(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('dosen.sistem_informasi.mahasiswa.jenis_indeks_prestasi_kumulatif_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
