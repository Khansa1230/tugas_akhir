...
class PediksiPerMahasiswaKlasifikasiC45MatematikaController extends Controller
{
    ...
    public function prediksi_per_mahasiswa_jurusan_matematika(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'matematika.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_matematika_mahasiswa',
