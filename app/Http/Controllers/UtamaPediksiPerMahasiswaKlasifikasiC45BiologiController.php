...
class UtamaPediksiPerMahasiswaKlasifikasiC45BiologiController extends Controller
{

    public function prediksi_per_mahasiswa_jurusan_biologi(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'utama.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_biologi_mahasiswa',
