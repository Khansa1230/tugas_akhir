...
class PediksiPerMahasiswaKlasifikasiC45FisikaController extends Controller
{
    ...
    public function prediksi_per_mahasiswa_jurusan_fisika(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'fisika.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_fisika_mahasiswa',
