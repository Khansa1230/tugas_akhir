...
class UtamaPediksiPerMahasiswaKlasifikasiC45TeknikInformatikaController extends Controller
{
    ...
    public function prediksi_per_mahasiswa_jurusan_teknik_informatika(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'utama.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_teknik_informatika_mahasiswa',
