...
class DosenKlasifikasiC45Controller extends Controller
{
    public function dosen_klasifikasi_mahasiswa_agribisnis(Request $request)
    {
      ...
      if ($output !== null) {
        ...
        return view('dosen.agribisnis.algoritma.klasifikasi_c45_matakuliah_agribisnis_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }
    
    public function dosen_prediksi_mahasiswa_agribisnis(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
       ...
       $query11 = DB::table('matakuliah as mk')
            ...
            ->select(
                ...
                DB::raw("CASE 
                    WHEN (js.jenis_sekolah IS NULL OR js.jenis_sekolah = '') THEN 
                        CASE 
                            WHEN mk.status = 'Lulus' THEN 'Lulus - Tidak Terdata'
                            ELSE 'Belum Lulus - Tidak Terdata'
                        END
                    ELSE js.jenis_sekolah
                END AS jenis_sekolah"),
                DB::raw("CASE 
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.agribisnis.algoritma.prediksi.prediksi_matakuliah_agribisnis_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }

    public function dosen_klasifikasi_mahasiswa_biologi(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.biologi.algoritma.klasifikasi_c45_matakuliah_biologi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }
    
    public function dosen_prediksi_mahasiswa_biologi(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
      ...
      $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.biologi.algoritma.prediksi.prediksi_matakuliah_biologi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }

    public function dosen_klasifikasi_mahasiswa_fisika(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.fisika.algoritma.klasifikasi_c45_matakuliah_fisika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }
    
    public function dosen_prediksi_mahasiswa_fisika(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.fisika.algoritma.prediksi.prediksi_matakuliah_fisika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }

    public function dosen_klasifikasi_mahasiswa_kimia(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.kimia.algoritma.klasifikasi_c45_matakuliah_kimia_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }
    
    public function dosen_prediksi_mahasiswa_kimia(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.kimia.algoritma.prediksi.prediksi_matakuliah_kimia_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }

    public function dosen_klasifikasi_mahasiswa_matematika(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.matematika.algoritma.klasifikasi_c45_matakuliah_matematika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }
    
    public function dosen_prediksi_mahasiswa_matematika(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.matematika.algoritma.prediksi.prediksi_matakuliah_matematika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }

    public function dosen_klasifikasi_mahasiswa_sistem_informasi(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.sistem_informasi.algoritma.klasifikasi_c45_matakuliah_sistem_informasi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }
    
    public function dosen_prediksi_mahasiswa_sistem_informasi(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.sistem_informasi.algoritma.prediksi.prediksi_matakuliah_sistem_informasi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }

    public function dosen_klasifikasi_mahasiswa_teknik_informatika(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.teknik_informatika.algoritma.klasifikasi_c45_matakuliah_teknik_informatika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }
    
    public function dosen_prediksi_mahasiswa_teknik_informatika(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('dosen.teknik_informatika.algoritma.prediksi.prediksi_matakuliah_teknik_informatika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));

    }

      public function dosen_klasifikasi_mahasiswa_teknik_tambang(Request $request)
    {
        // Ambil input dari pengguna
        $predictedLulus = $request->input('predicted_lulus');
        // Hitung test_size
       ...
       // Konversi hasil query ke array
        ...
        return view('dosen.teknik_tambang.algoritma.klasifikasi_c45_matakuliah_teknik_tambang_mahasiswa', compact('outputData', 'predictedLulus' 
            ));
    }

    public function dosen_prediksi_mahasiswa_teknik_tambang(Request $request)
    {
       ...
       // Konversi hasil query ke array
        ...
        // Mengembalikan view dengan data dan pemetaan kolom
        return view('dosen.teknik_tambang.algoritma.prediksi.prediksi_matakuliah_teknik_tambang_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'
            ));
    }
