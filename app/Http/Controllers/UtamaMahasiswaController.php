...
class UtamaMahasiswaController extends Controller
{
    public function jumlah_mahasiswa_kelamin(Request $request) {
        ...
        return view('utama.mahasiswa.jenis_kelamin_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }
    ...
    public function jumlah_mahasiswa_status(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('utama.mahasiswa.jenis_status_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'query'));
    }
    ...
    public function jumlah_mahasiswa_jurusan(Request $request) {
        ...
        //dd($query);
        // Mengembalikan view dengan data yang diperlukan
        return view('utama.mahasiswa.jenis_jurusan_mahasiswa', compact('years', 'allStatus', 'selectedStatus', 'query'));
    }
    ...
    public function jumlah_mahasiswa_jenis_seleksi(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('utama.mahasiswa.jenis_seleksi_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }
    ...
    public function jumlah_mahasiswa_propinsi(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('utama.mahasiswa.jenis_propinsi_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }
    ...
    public function jumlah_mahasiswa_kota(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('utama.mahasiswa.jenis_kota_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'allPropinsi', 'selectedJurusan', 'selectedStatus'));
    }
    ...
    public function jumlah_mahasiswa_jenis_sekolah(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('utama.mahasiswa.jenis_sekolah_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }
    ...
    public function jumlah_mahasiswa_satuan_kredit_semester(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('utama.mahasiswa.jenis_satuan_kredit_semester_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }
    ...
    public function jumlah_mahasiswa_indeks_prestasi_kumulatif(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('utama.mahasiswa.jenis_indeks_prestasi_kumulatif_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }
