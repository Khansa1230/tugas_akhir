...
class PediksiPerMahasiswaKlasifikasiC45TeknikTambangController extends Controller
{

    public function prediksi_per_mahasiswa_jurusan_teknik_tambang(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'teknik_tambang.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_teknik_tambang_mahasiswa',
