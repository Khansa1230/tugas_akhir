...
{ 
    public function klasifikasi_mahasiswa_agribisnis(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        return view('agribisnis.algoritma.klasifikasi_c45_matakuliah_agribisnis_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function prediksi_mahasiswa_agribisnis(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('agribisnis.algoritma.prediksi.prediksi_matakuliah_agribisnis_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
