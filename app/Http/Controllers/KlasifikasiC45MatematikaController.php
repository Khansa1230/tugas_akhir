...
class KlasifikasiC45MatematikaController extends Controller
{
    public function klasifikasi_mahasiswa_matematika(Request $request)
    {
        ...
        return view('matematika.algoritma.klasifikasi_c45_matakuliah_matematika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function prediksi_mahasiswa_matematika(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('matematika.algoritma.prediksi.prediksi_matakuliah_matematika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
