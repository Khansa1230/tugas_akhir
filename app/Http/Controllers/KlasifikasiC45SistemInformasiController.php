...
class KlasifikasiC45SistemInformasiController extends Controller
{
    public function klasifikasi_mahasiswa_sistem_informasi(Request $request)
    {
        ...
        return view('sistem_informasi.algoritma.klasifikasi_c45_matakuliah_sistem_informasi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function prediksi_mahasiswa_sistem_informasi(Request $request)
    {
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('sistem_informasi.algoritma.prediksi.prediksi_matakuliah_sistem_informasi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
