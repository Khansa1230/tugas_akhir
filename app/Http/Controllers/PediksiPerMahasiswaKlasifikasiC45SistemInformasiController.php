...
class PediksiPerMahasiswaKlasifikasiC45SistemInformasiController extends Controller
{

    public function prediksi_per_mahasiswa_jurusan_sistem_informasi(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'sistem_informasi.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_sistem_informasi_mahasiswa',
