...
class MahasiswaMatematikaController extends Controller
{
    public function jumlah_mahasiswa_kelamin_matematika(Request $request) {
        ...
        return view('matematika.mahasiswa.jenis_kelamin_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
    
    public function jumlah_mahasiswa_status_matematika(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('matematika.mahasiswa.jenis_status_mahasiswa', compact('years',  'allStatus',  'query'));
    }

    public function jumlah_mahasiswa_jurusan_matematika(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
    ...
    public function jumlah_mahasiswa_jenis_seleksi_matematika(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('matematika.mahasiswa.jenis_seleksi_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
    
    public function jumlah_mahasiswa_propinsi_matematika(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('matematika.mahasiswa.jenis_propinsi_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }

    public function jumlah_mahasiswa_kota_matematika(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('matematika.mahasiswa.jenis_kota_mahasiswa', compact('years',  'allStatus', 'allPropinsi',  'selectedStatus'));
    }
    
    
    public function jumlah_mahasiswa_jenis_sekolah_matematika(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('matematika.mahasiswa.jenis_sekolah_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }

    public function jumlah_mahasiswa_satuan_kredit_semester_matematika(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('matematika.mahasiswa.jenis_satuan_kredit_semester_mahasiswa', compact('years', 'allStatus', 'selectedStatus', 'query'));
    }
    

    public function jumlah_mahasiswa_indeks_prestasi_kumulatif_matematika(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('matematika.mahasiswa.jenis_indeks_prestasi_kumulatif_mahasiswa', compact('years',  'allStatus',  'selectedStatus', 'query'));
    }
