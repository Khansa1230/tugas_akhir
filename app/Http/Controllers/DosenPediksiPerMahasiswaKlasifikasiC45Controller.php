...
class DosenPediksiPerMahasiswaKlasifikasiC45Controller extends Controller
{
   public function dosen_prediksi_per_mahasiswa_jurusan_agribisnis(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'dosen.agribisnis.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_agribisnis_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }
 
    public function dosen_prediksi_per_mahasiswa_jurusan_biologi(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'dosen.biologi.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_biologi_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }
     
    public function dosen_prediksi_per_mahasiswa_jurusan_fisika(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'dosen.fisika.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_fisika_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }

     public function dosen_prediksi_per_mahasiswa_jurusan_kimia(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'dosen.kimia.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_kimia_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }

    public function dosen_prediksi_per_mahasiswa_jurusan_matematika(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'dosen.matematika.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_matematika_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }

    public function dosen_prediksi_per_mahasiswa_jurusan_sistem_informasi(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'dosen.sistem_informasi.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_sistem_informasi_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }

    public function dosen_prediksi_per_mahasiswa_jurusan_teknik_informatika(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'dosen.teknik_informatika.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_teknik_informatika_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }
     public function dosen_prediksi_per_mahasiswa_jurusan_teknik_tambang(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'dosen.teknik_tambang.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_teknik_tambang_mahasiswa',
            compact('outputData', 'columnMapping', 'predictedLulus', 'statusPrediksi', 'nim', 'results')
        );
    }
