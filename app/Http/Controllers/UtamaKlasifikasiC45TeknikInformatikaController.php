...
class UtamaKlasifikasiC45TeknikInformatikaController extends Controller
{
    public function klasifikasi_mahasiswa_jurusan_teknik_informatika(Request $request)
    {
        ...
        return view('utama.algoritma.klasifikasi_c45_matakuliah_teknik_informatika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function prediksi_mahasiswa_jurusan_teknik_informatika(Request $request)
    {
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('utama.algoritma.prediksi.prediksi_matakuliah_teknik_informatika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
