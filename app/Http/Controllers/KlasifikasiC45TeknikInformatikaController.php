...
class KlasifikasiC45TeknikInformatikaController extends Controller
{
    public function klasifikasi_mahasiswa_teknik_informatika(Request $request)
    {
        ...
        return view('teknik_informatika.algoritma.klasifikasi_c45_matakuliah_teknik_informatika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function prediksi_mahasiswa_teknik_informatika(Request $request)
    {
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('teknik_informatika.algoritma.prediksi.prediksi_matakuliah_teknik_informatika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
