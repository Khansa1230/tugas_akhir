...
class UtamaPediksiPerMahasiswaKlasifikasiC45KimiaController extends Controller
{

    public function prediksi_per_mahasiswa_jurusan_kimia(Request $request)
    {
       ...
       $outputData = [
        ...
        // Return ke view
        return view(
            'utama.algoritma.prediksi.permahasiswa.prediksi_per_mahasiswa_matakuliah_kimia_mahasiswa',
