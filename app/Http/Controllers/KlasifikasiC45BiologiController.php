...
{ 
    public function klasifikasi_mahasiswa_biologi(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        return view('biologi.algoritma.klasifikasi_c45_matakuliah_biologi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function prediksi_mahasiswa_biologi(Request $request)
    {
      ...
      $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('biologi.algoritma.prediksi.prediksi_matakuliah_biologi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
