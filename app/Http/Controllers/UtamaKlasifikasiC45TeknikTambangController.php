...
class UtamaKlasifikasiC45TeknikTambangController extends Controller
{
    ...
    public function klasifikasi_mahasiswa_jurusan_teknik_tambang(Request $request)
    {
       ...
       // Konversi hasil query ke array
        ...
        return view('utama.algoritma.klasifikasi_c45_matakuliah_teknik_tambang_mahasiswa', compact('outputData', 'predictedLulus' 
            ));
    }
    ...
    public function prediksi_mahasiswa_jurusan_teknik_tambang(Request $request)
    {
       ...
       // Konversi hasil query ke array
        ...
        // Mengembalikan view dengan data dan pemetaan kolom
        return view('utama.algoritma.prediksi.prediksi_matakuliah_teknik_tambang_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'
            ));
    }
}
