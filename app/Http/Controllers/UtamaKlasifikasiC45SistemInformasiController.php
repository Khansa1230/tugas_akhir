...
class UtamaKlasifikasiC45SistemInformasiController extends Controller
{
    public function klasifikasi_mahasiswa_jurusan_sistem_informasi(Request $request)
    {
        ...
        return view('utama.algoritma.klasifikasi_c45_matakuliah_sistem_informasi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function prediksi_mahasiswa_jurusan_sistem_informasi(Request $request)
    {
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('utama.algoritma.prediksi.prediksi_matakuliah_sistem_informasi_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
