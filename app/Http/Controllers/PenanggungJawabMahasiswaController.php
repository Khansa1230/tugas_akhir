...
class PenanggungJawabMahasiswaController extends Controller
{
    public function penanggung_jawab_jumlah_mahasiswa_kelamin(Request $request) {
        ...
        return view('penanggung_jawab.mahasiswa.jenis_kelamin_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }
    
    public function penanggung_jawab_jumlah_mahasiswa_status(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_status_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'query'));
    }

    public function penanggung_jawab_jumlah_mahasiswa_jurusan(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        //dd($query);
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_jurusan_mahasiswa', compact('years', 'allStatus', 'selectedStatus', 'query'));
    }
    
    public function penanggung_jawab_jumlah_mahasiswa_jenis_seleksi(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_seleksi_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }
    
    public function penanggung_jawab_jumlah_mahasiswa_propinsi(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_propinsi_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }

    public function penanggung_jawab_jumlah_mahasiswa_kota(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_kota_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'allPropinsi', 'selectedJurusan', 'selectedStatus'));
    }
    
    
    public function penanggung_jawab_jumlah_mahasiswa_jenis_sekolah(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_sekolah_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }

    public function penanggung_jawab_jumlah_mahasiswa_satuan_kredit_semester(Request $request) {
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_satuan_kredit_semester_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }
    

    public function penanggung_jawab_jumlah_mahasiswa_indeks_prestasi_kumulatif(Request $request) {
        // Mengambil tahun angkatan mahasiswa (tanpa filter status)
        $years = DB::table('mahasiswa as m')
            ->select(DB::raw('YEAR(m.tahun_angkatan) as year'))
            ->groupBy('year')
        ...
        // Mengembalikan view dengan data yang diperlukan
        return view('penanggung_jawab.mahasiswa.jenis_indeks_prestasi_kumulatif_mahasiswa', compact('years', 'allJurusan', 'allStatus', 'selectedJurusan', 'selectedStatus', 'query'));
    }
