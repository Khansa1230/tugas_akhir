...
{ 
    public function klasifikasi_mahasiswa_fisika(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        return view('fisika.algoritma.klasifikasi_c45_matakuliah_fisika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function prediksi_mahasiswa_fisika(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('fisika.algoritma.prediksi.prediksi_matakuliah_fisika_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
