...
{ 
    public function klasifikasi_mahasiswa_jurusan_agribisnis(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        return view('utama.algoritma.klasifikasi_c45_matakuliah_agribisnis_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
    ...
    public function prediksi_mahasiswa_jurusan_agribisnis(Request $request)
    {
       ...
       $query11 = DB::table('matakuliah as mk')
        ...
        // Kembalikan ke view (jika tidak pakai DD)
        return view('utama.algoritma.prediksi.prediksi_matakuliah_agribisnis_mahasiswa', compact('outputData', 'columnMapping', 'predictedLulus'));
